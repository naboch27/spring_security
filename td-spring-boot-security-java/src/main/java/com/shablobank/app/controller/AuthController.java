...
public class AuthController {
	...
	@PostMapping("/signin")
	public ResponseEntity<HashMap> authenticateUser(@RequestBody @Valid LoginDto loginDto, BindingResult bindingResult)
	...
	public ResponseEntity<?> registerUser(@RequestBody User signUpDto) {
		...
		return ResponseEntity.status(HttpStatus.OK).body(Map.of("id", _user.getId(), "createdAt", _user.getCreatedAt(),
				"firstname", _user.getFirstname(), "lastname", _user.getLastname(), "email", _user.getEmail()
